...
$(document).ready(function () {
    ...
    function onFocus() {
        ...
        document.title = ((!$(".chamado-row").length ? "(vazio)" : "(" + $(".chamado-row").length + ")") + " Chamados designados (Técnico)");
    }
                        ...
                        if (document.body.className === 'blurred') {
                            if ($(".chamado-row").length) {
                                ...
                                notifyInterval = setInterval(function () {
                                    var title = ((!$(".chamado-row").length ? "(vazio)" : "(" + $(".chamado-row").length + ")") + " Chamados designados (Técnico)");
                                    document.title = val ? "Lista atualizada" : title;
                                    val = !val;
                                }, 1000);
                                $("#notification")[0].play();
                            } else {
                                document.title = "(vazio) Chamados designados (Técnico)";
                            }
                        }
                    }
                },
