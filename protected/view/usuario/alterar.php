                    ...
                    <fieldset>
                        ...
                        <?php if (isset($response['data'])) { ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="cpf" name="cpf" type="text" value="<?= $response['data']['cpf'] ?>" class="input-xlarge" readonly>
                                </div>
                            </div>
                            <hr>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="email" name="email" type="text" value="<?= $response['data']['email'] ?>" placeholder="email@dominio.com" class="input-xlarge">
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="ip" name="ip" type="text" value="<?= $response['data']['ip'] ?>" placeholder="_._._._" class="input-xlarge">
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="controls">
                            ...
                            <div>
                                <div class="controls">
                                    <a href="/v/<?= $response['data']['tecnico'] ? "tecnico" : "usuario" ?>/listar/" class="btn row-fluid">Voltar</a>
                                </div>
                            </div>
                        <?php } ?>
                    </fieldset>
